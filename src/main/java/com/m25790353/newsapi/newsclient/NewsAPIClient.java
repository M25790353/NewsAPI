...
public class NewsAPIClient {
    ...
    public Response getTopHeadlines() {
        ...
        try {
            ...
            String parameters = "?country=us&category=business";

            String sender = BASE_URL + HEADLINES + parameters + "&apiKey=" + NEWS_ORG_KEY;
            System.out.println("sender: " + sender);

            Response response = restClient.get()
                    .uri(BASE_URL + HEADLINES + parameters + "&apiKey=" + NEWS_ORG_KEY)
