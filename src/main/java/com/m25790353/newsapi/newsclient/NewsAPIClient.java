    ...
    public Response getHeadlines(TopHeadlinesRequest request) {
            ...
            Response response = restClient.get()
                    .uri( UriComponentsBuilder.fromUriString(BASE_URL)
                            ...
                            .queryParamIfPresent(LANGUAGE, Optional.ofNullable(request.getLanguage()))
                            .queryParamIfPresent(PAGE, Optional.ofNullable(request.getPage()))
                            .queryParamIfPresent(PAGE_SIZE, Optional.ofNullable(request.getPageSize()))
    ...
    public Response search(EverythingRequest request) {
        ...
        Response response = restClient.get()
                .uri( UriComponentsBuilder.fromUriString(BASE_URL)
                        ...
                        .queryParamIfPresent(EXCLUDE_DOMAINS, Optional.ofNullable(request.getExcludeDomains()))
                        .queryParamIfPresent(SEARCH_IN, Optional.ofNullable(request.getSearchIn()))
