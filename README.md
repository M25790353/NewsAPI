...
Docker Compose file docker_mongodb.yaml is for spinning-up the mongodb and mongo-express to be used locally for developlent.

To start: have Docker up and running
At a terminal, run "docker compose -f docker_mongodb.yaml up"
At this point Mongo Express web page, a tool to monitor the MongoDB database is up and running. This can be accessed with http://localhost:8081/ and a user name "admin" with a password "pass".

To shutdown the database, run "docker compose -f docker_mongodb.yaml down"
...
| 18/03/25 | Study Spring                                                                                                                                           |
| 19/03/25 | Study Spring,  addded mongodb and mongodb as container                                                                                                                                           |
...
- Dockerfile <br/>
  &emsp; _ multistage build <br/>
  &emsp; _ mongodb for <br/>
  Docker _ Compose <br/>
  &emsp; _ version for development <br/>
...
- GoLang <br/>
- Jenkins Pipeline <br/>
  &emsp; _ study documnetation<br/>
  &emsp; _ Jenkinsfile for build stage <br/>
- Java/Spring <br/>
- Bitbucket <br/>
- Ansible <br/>
- Maven <br/>
...
- App
  _ Frontend
  &emsp; _ web page to request newsfeed
  &emsp; _ react frontend
  _
